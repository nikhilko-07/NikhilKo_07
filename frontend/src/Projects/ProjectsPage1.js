...
import Node from "./NodeMailer.png";
  ...
  return (
    <div className={`${Style.container} container`}>
      ...
      <div className={Style.list}>
          <li><img src={Linkedin}/><span><a className={Style.links} href="https://linkedin-clone-sandy-eight.vercel.app"><h3>Linkedin Clone Project</h3><p>click to go github page</p></a></span></li>
          <li><img src={Node}/><span><a className={Style.links} href="https://gmail.nikhil.my"><h3>Soil info Project</h3><p>click to go github page</p></a></span></li>
