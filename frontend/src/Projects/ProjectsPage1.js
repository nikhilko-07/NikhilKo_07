  ...
  return (
    <div className={`${Style.container} container`}>
      ...
      <div className={Style.list}>
          ...
          <li><img src={MemoryGame}/><span><a href="https://github.com/nikhilko-07/Memory-Card-Game" className={Style.links} ><h3>Linkedin Clone</h3><p>click to go github page</p></a></span></li>
      </div>
    </div>
  )
}
